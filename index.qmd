---
title: "<span class='quarto-title-span px-5 py-2' style='inline-block'>DSAN Mentorship Program</span>"
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-familiar-checkbox" value="Familiar with life in DC" checked disabled>
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-international-checkbox" value="Familiar with international student processes" checked disabled>
    <label class="form-check-label" for="strength-international-checkbox">
      <i class="bi bi-globe pe-1"></i>Familiar with international student processes
    </label>
</div>

<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-friendly-checkbox" value="Friendly and welcoming" checked disabled>
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-campus-checkbox" value="Familiar with the campus" checked disabled>
    <label class="form-check-label" for="strength-campus-checkbox">
      <i class="bi bi-compass-fill pe-1"></i>Familiar with the campus
    </label>
</div>

<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-experience-checkbox" value="Work/internship experience" checked disabled>
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="strength-mentor-checkbox" value="I used to be a mentor in my undergrad" checked disabled>
    <label class="form-check-label" for="strength-mentor-checkbox">
      <i class="bi bi-mortarboard-fill pe-1"></i>I used to be a mentor in my undergrad
    </label>
</div>
...
var strengthDict = {
  ...
  "Familiar with international student issues": "fa-solid fa-globe",
  "Friendly and welcoming": "fa-solid fa-face-smile",
  "Strong academically": "fa-solid fa-award",
  "I enjoy organizing social activities": "fa-solid fa-people-group",
  "Familiar with the campus": "fa-solid fa-building-columns",
  "Work/internship experience": "fa-solid fa-briefcase",
