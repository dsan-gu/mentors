---
title: "<span class='quarto-title-span px-5 py-2' style='display: inline-block'>DSAN Mentorship Program 2026</span>"
...
<div class="column-body" id="table-column">
  <p>
  Welcome to the 2026 DSAN Mentorship Program at Georgetown University! Browse available mentors in the list below, (optionally) using the filters on the right to narrow the list, then indicate the <b>ID</b> values for your top 10 preferences in the mentorship preferences form.
  </p>
  <table
    id="mentor-table"
...
<script>
$.get("data/2026_mentors_anonymized.csv", function(data){
  Papa.parse(data, {
    header: true,
